    ...
    <div className="flex justify-center items-center w-full h-[300px] p-4">
      <div className="w-[900px] h-[200px]">
        <p>
          ...
          KHUSHIYAN (basic needs provisions), AURAT (women's empowerment), VASTR
          (clothing support), and PARAMARSH (motivational guidance), we strive
          to create sustainable opportunities for underprivileged communities.
          Registered under the Ministry of Corporate Affairs and recognized by
          NITI Aayog, we are committed to nurturing potential, breaking
          barriers, and enabling marginalized individuals to achieve their
          dreams and contribute meaningfully to national growth.
        </p>
      </div>
    </div>
  );
